              ...
              <div class="flex items-center space-x-4">
                ...
                <button class="relative">
                  <span>
                    ...
                    >
                      <path
                        d="M11.4635 4.61416H14.471V14.1379C14.471 15.5477 13.3432 16.6442 11.9648 16.6442H2.94229C1.53252 16.6442 0.436035 15.5477 0.436035 14.1379V4.61416H3.44354C3.44354 2.42119 5.22924 0.604159 7.45354 0.604159C9.6465 0.604159 11.4635 2.42119 11.4635 4.61416ZM7.45354 2.10791C6.04377 2.10791 4.94729 3.23572 4.94729 4.61416H9.95979C9.95979 3.23572 8.83197 2.10791 7.45354 2.10791ZM12.9673 14.1379V6.11791H11.4635V7.37103C11.4635 7.80963 11.1189 8.12291 10.7117 8.12291C10.2731 8.12291 9.95979 7.80963 9.95979 7.37103V6.11791H4.94729V7.37103C4.94729 7.80963 4.60268 8.12291 4.19541 8.12291C3.75682 8.12291 3.44354 7.80963 3.44354 7.37103V6.11791H1.93979V14.1379C1.93979 14.7018 2.37838 15.1404 2.94229 15.1404H11.9648C12.4974 15.1404 12.9673 14.7018 12.9673 14.1379Z"
                        fill="white"
                      />
                    </svg>
                  </span>
      ...
      <section className="hero h-screen relative">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div class="flex flex-col items-center py-10 px-6">
            <h2 class="mb-2 font-spartan text-[20px] font-bold leading-[22.4px]">
            ...
            <div class="flex space-x-4 mt-6">
              ...
              <button class="border border-gray-300 py-2 px-4 hover:bg-gray-200 transition rounded-[50px]">
                Explore Products
              </button>
            </div>
          </div>
        ...
        <section>
          <div className="max-w-screen-xl w-full px-4 mx-auto">
            <div className="premium-product py-[60px]">
              <div>
                <h4 className="text-center text-[45px] font-bold">
                ...
                <ul className="flex gap-[30px] justify-center mt-[40px]">
                  <li className="flex flex-col justify-center items-center">
                    <Image
                      ...
                      src={vegetable1Img}
                    />
                    <h5 className="text-[15px] font-bold mt-[12px]">
                      Vegetables
                    </h5>
                  </li>
                  <li className="flex flex-col justify-center items-center">
          ...
          <div className="max-w-screen-xl w-full px-4 mx-auto">
            <div className="grid-cols-4 grid gap-[15px] mt-[80px]">
              <div className="premium_product_card p-[10px] bg-white rounded-[10px]">
                ...
                <h5 className="text-[18px] font-bold text-center mt-[15px]">
                  Brown Bread
                </h5>
