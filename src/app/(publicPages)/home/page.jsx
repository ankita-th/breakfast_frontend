    ...
    <div className="hero-bg-img">
      ...
      <section>
        <div className="max-w-screen-xl w-full px-4 mx-auto">
          ...
          <div className="grid grid-cols-2 gap-6 mt-20 mob-width-card">
            <div className="md:pl-[140px] mb-10 pl-[0px] organic_cards">
              <div className="bg-white rounded-lg shadow-md p-4 w-full relative md:pl-[120px] pl-[1rem] inner_card_organic">
                <Image
                  src={productImg}
                  className="text-transparent absolute left-[-20px] max-w-[240px] translate-x-[-50%]"
                  alt="productImg"
                />
                ...
                <h2 className="text-2xl font-bold text-black mt-2">{T.brown_bread}</h2>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="flex space-x-2 add-cart-card">
                    <a
                      href="#"
        ...
        <section className="before:absolute before:top-0 before:left-0 before:content-[''] before:w-full before:h-full before:bg-[#92C64E] before:z-[-1] z-[1] before:-rotate-2 py-[60px] relative">
          <div className="max-w-screen-xl w-full px-4 mx-auto">
            <div className="grid-cols-2 gap-[20px] grid md:grid-cols-4 expert-tem-sec">
              ...
              <div className="flex gap-[15px] items-center">
                <div className="w-[100px] h-[100px] bg-white p-0 rounded-full flex justify-center items-center md:w-[80px] md:h-[80px] review-icon-bg">
                  <Image className="w-[60px] md:w-[40px]" src={review4Img} alt="reviewImg" />
                </div>
                <div className="expert-mob-heading">
                  <h6 className="text-[40px] font-extrabold text-white md:text-[32px]">27</h6>
                  <p className="text-[#E2E2E2] text-[20px] font-medium md:text-[17px]">
                  {T.awards_winning}
                  </p>
                </div>
